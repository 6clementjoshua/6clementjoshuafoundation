        ...
        <div className="mx-auto max-w-6xl px-4 py-3">
          <div className="flex items-center justify-between gap-3">
            ...
            <Link href="/" className="flex items-center gap-3">
              {/* ✅ LOGO FIXED HERE */}
              <div className="h-10 w-10 rounded-2xl border border-black/10 bg-white shadow-sm overflow-hidden">
                <Image
                  src="/6logo.PNG"
                  alt="6Clement Joshua Foundation Logo"
                  width={40}
                  height={40}
