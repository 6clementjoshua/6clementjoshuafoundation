...
export default function SiteHeader() {
    ...
    return (
        <>
            {/* FIXED header: page scrolls under it */}
            <header className="fixed top-0 left-0 right-0 z-50 bg-white/70 backdrop-blur border-b border-black/10">
                <div className="mx-auto max-w-6xl px-4 py-3">
                    <div className="flex items-center justify-between gap-3">
                        ...
                        {/* Mobile: menu icon only (tap again closes) */}
            ...
            {/* IMPORTANT: push the page content down so it doesn't hide under the fixed header */}
