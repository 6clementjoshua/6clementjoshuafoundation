...
export default function DonatePage() {
  ...
  useEffect(() => {
    ...
    async function verifyReturnedFlutterwavePayment() {
      const url = new URL(window.location.href);

      const returnedStatus = url.searchParams.get("status");
      const txRef =
      ...
      try {
        ...
        const res = await fetch("/api/donate/flutterwave/verify", {
          method: "POST",
        ...
        if (txRef) cleanUrl.searchParams.set("ref", txRef);
    ...
    verifyReturnedFlutterwavePayment();
          ...
          <div className="flex flex-wrap items-center justify-between gap-3">
            <div>
              ...
              <p className="mt-3 max-w-2xl text-black/70 leading-relaxed">
                Secure checkout. We do not store bank or card information.
                You’ll receive a confirmation email after payment is confirmed.
              </p>
            </div>
            ...
            {status === "canceled" ? (
              ...
              >
                ...
                <div className="mt-1 text-sm text-black/70">
                  It looks like the payment wasn’t completed. You can try again
                  anytime.
                </div>
              </motion.div>
            ) : null}
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-black/70">
                      Thank you. A confirmation email has been sent (check
                      spam/junk if needed).
                      {ref ? (
                        <>
                          {" "}
          ...
          <div className="mt-8 grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div className="glass rounded-[2rem] p-6 sm:p-8">
              ...
              <div className="mt-5 text-xs text-black/55 leading-relaxed">
                ...
                , and{" "}
                <Link className="underline" href="/policies/donor-privacy">
                  Donor Privacy
                </Link>
                .
              </div>
            ...
            <div className="glass rounded-[2rem] p-6 sm:p-8">
              ...
              <p className="mt-2 text-sm text-black/70 leading-relaxed">
                We never store your bank/card details. Payment is handled by the
                selected processor.
              </p>
              ...
              <div className="mt-6 grid grid-cols-1 gap-3">
                <button
                  disabled={
                    !canPay ||
                    loading !== null ||
                    providerRecommended !== "flutterwave"
                  }
                ...
                <div className="rounded-2xl border border-black/10 bg-black/[0.03] p-4 text-sm text-black/75 leading-relaxed">
                  ...
                  <span className="font-semibold">
                    large donations, corporate giving, or bank transfers
                  </span>
                ...
                <div className="rounded-2xl border border-black/10 bg-black/[0.03] p-5 text-sm text-black/70 leading-relaxed">
                  If you return from checkout without completing payment, this
                  page will show “Payment not received”. Once payment is
                  confirmed, you’ll see success and receive an email
